      ...
      <div className="space-y-3">
        ...
        <div className="flex items-start justify-between">
          ...
          {!isSelected && (
            <Badge 
              variant="outline"
              className={`rounded-none text-[9px] uppercase tracking-widest border-0 px-1.5 py-0.5 ${
                unit.status === 'VACANT' 
        ...
        <div className="space-y-1.5 text-xs font-mono border-t border-dashed border-border/50 pt-2">
          ...
          {unit.propertyTitle && (
            <div className="flex justify-between items-baseline">
              ...
              <span className="font-medium text-[10px] truncate max-w-[100px]" title={unit.propertyTitle.titleNo}>
